...
###############################
setwd("//econha01/client/CLIENT/1 Consulting/Freddie Mac/Prediction Modeling/NV/data/sensing")
# packages
library(tidyverse)
library(sf)
library(stars)
...
#Nevada: 14 mins
tictoc::tic()
terra::writeRaster(whole, filename = "comp_32.tif")
tictoc::toc()
...
write_csv(st_drop_geometry(zonal_stats), glue::glue("remote_sensing_{geography}.csv"))
